...
namespace Utilities
{
    public class OAuthHandler
    {
        ...
        {
            string aadTenant = ConnectionSettings.Default.ActiveDirectoryTenant;
            string aadClientAppId = ConnectionSettings.Default.ActiveDirectoryClientAppId;
            string aadClientAppSecret = ConnectionSettings.Default.ActiveDirectoryClientAppSecret;
            string aadResource = ConnectionSettings.Default.ActiveDirectoryResource;
            ...
            else
            {
                ...
                string username = ConnectionSettings.Default.UserName;
                string password = ConnectionSettings.Default.Password;
                ...
                try
                {
                    ...
                    //var userCredential = new UserAssertionusername, password); ;
